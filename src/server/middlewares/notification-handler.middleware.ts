...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'message.create': {
    roles: ['agency-owner', 'team-member'],
    key: 'new-customer-message',
    tenantPath: [],
    userPath: [],
  },
  'team_member.update': {
    ...
    tenantPath: ['agency', 'team_member'],
    userPath: [],
  },
  'educational_content.create': {
    roles: ['customer'],
    key: 'new-educational-content',
    tenantPath: ['agency', 'educational_content'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['agency-owner', 'team-member'];
