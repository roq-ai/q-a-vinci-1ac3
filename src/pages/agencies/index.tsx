...
export function AgencyListPage(props: AgencyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getAgencies({
        relations: ['user', 'educational_content.count', 'team_member.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('educational_content', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'educational_content',
          header: 'Educational Content',
          accessorKey: 'educational_content',
          cell: ({ row: { original: record } }: any) => record?._count?.educational_content,
        }
      : null,
